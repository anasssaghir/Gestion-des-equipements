...
if(ISSET($_POST['submit'])){
	...
	die("connection failed".mysqli_connect_error());
		...
		$sql = "delete from demande_equipement where idDemandesEquipement='".$_POST['A']."'";
		if(mysqli_query($con,$sql)){
			echo "Nouvelle demande des equipement traiter";
		}else{
...
{
?>
    <option value="<?php echo $donnees['idDemandesEquipement']; ?>"><?php echo $donnees['idDemandesEquipement'] ; ?> - <?php echo $donnees['nom_equipement']; ?></option>
	<?php
}
?>
	</SELECT>
